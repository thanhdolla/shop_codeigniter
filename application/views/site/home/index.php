...
<div class="box-center"> 
    <div style="color:#002166;font-size: 27px;margin-top: 10px;">
    ...
    <div class="box-content-center product"> 
        <?php foreach ($sanpham as $row): ?>
            <div class="sp" onclick="location.href = '<?php echo base_url('sanpham/view/' . $row->san_phamID) ?>'">
                ...
                <div class="sanpham">
                    <div class="tensp" style="text-align:center;margin-top: 5px;padding-bottom: 3px;font-family: sans-serif;font-size: 18px;">

                        <b title=" <?php echo $row->ten_sp ?>" >
                            <?php echo $row->ten_sp ?>
                        </b>
