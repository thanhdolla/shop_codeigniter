...
<div class="box-center"> 
    <div style="color:#002166;font-size: 27px;">
        <b><span class="glyphicon glyphicon-th-list"></span> Kết quả với từ khóa "<?php echo $key ?>"</b> (<?php echo count($list2); ?>)<hr>
    </div>
    <div class="box-content-center product"> 
        <?php foreach ($list2 as $row): ?>
            <div class="sp" onclick="location.href = '<?php echo base_url('sanpham/view/' . $row->san_phamID) ?>'">
                ...
                <div class="hover">
                    <a href="<?php echo base_url('cart/add/' . $row->san_phamID) ?>"><button  class="btn btn-danger">Thêm vào giỏ hàng</button></a>
                </div>
                <div class="text">
